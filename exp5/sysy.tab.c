...
static const yytype_uint8 yyrline[] =
{
      ...
      65,    68,    70,    71,    74,    75,    78,    79,    82,    83,
      86,    87,    88,    91,    92,    95,    96,    97,    99,   100,
     102,   105,   107,   108,   109,   111,   112,   113,   114,   115,
     116,   117,   118,   119,   120,   123,   126,   127,   130,   132,
...
static const char *const yytname[] =
{
  ...
  "InitVal", "InitValMul", "FuncDec", "VarList", "ParamDec", "CompSt",
  "StmDefList", "Stmt", "ForArgs", "ForArg", "Def", "DecList", "Exp",
  "Args", YY_NULLPTR
};
#endif
...
{
     106,   -12,  -123,  -123,    19,    44,  -123,   106,    47,    49,
    -123,    61,  -123,  -123,    -9,    24,    40,    70,    59,    55,
      59,    65,    78,    10,   294,  -123,  -123,   259,    61,   215,
    -123,  -123,  -123,    86,  -123,    61,    92,    95,  -123,    15,
    -123,   294,   294,   294,    25,     7,   252,  -123,   174,  -123,
     265,   112,   113,   114,   116,   117,    61,  -123,   120,   215,
     215,    57,  -123,  -123,  -123,    19,   288,    91,  -123,   174,
    -123,  -123,   294,    65,   294,   294,   294,   294,   294,   294,
     294,   294,  -123,  -123,    -5,  -123,   104,   294,   294,   236,
     294,  -123,  -123,   121,   119,  -123,  -123,  -123,  -123,  -123,
    -123,   123,   129,  -123,    68,  -123,   181,    51,    51,  -123,
    -123,    51,    45,    45,  -123,   259,  -123,   141,   124,   174,
    -123,   159,    61,  -123,   294,  -123,  -123,   236,   294,   236,
    -123,  -123,   138,   126,  -123,   236,   294,  -123,   142,  -123
};
...
static const yytype_int8 yydefact[] =
{
       ...
       9,     0,     1,     4,    15,     0,    18,    12,     0,     0,
       0,    15,     0,     0,     0,    14,     5,     0,     0,    32,
       7,     8,     6,     0,    26,     0,     0,    28,    68,    15,
      69,     0,     0,     0,    67,     0,     0,    19,    20,    13,
       0,     0,     0,     0,     0,     0,     0,    36,     0,    32,
      32,     0,    27,    30,    25,     0,     0,     0,    64,    63,
      60,    61,     0,    16,     0,     0,     0,     0,     0,     0,
       0,     0,    21,    23,     0,    38,     0,     0,    46,     0,
       0,    43,    42,    49,     0,    31,    33,    34,    35,    29,
      66,    71,     0,    62,    54,    17,    51,    56,    55,    57,
      58,    59,    52,    53,    22,     0,    37,     0,     0,    47,
      44,     0,     0,    48,     0,    65,    24,     0,    46,     0,
      50,    70,    39,     0,    41,     0,    46,    40,     0,    45
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int16 yypgoto[] =
{
    -123,  -123,   155,  -123,     1,  -123,     4,    -8,    90,   -25,
     -44,  -123,   156,   101,  -123,    27,    58,   -55,  -123,  -122,
    -123,    46,   -20,    43
};
...
{
      -1,     5,     6,     7,    56,     9,    15,    44,    25,    17,
      47,    84,    18,    36,    37,    57,    58,    59,    89,   118,
      60,    94,    61,   102
};
...
{
      16,     8,    83,    16,    45,    11,   133,    48,     8,    23,
      63,    24,    72,    10,   138,    22,     2,    33,   114,   115,
      16,    67,    68,    69,    35,     2,    48,    16,    73,    34,
      86,    93,    49,    66,   120,    24,    74,    75,    76,    77,
      78,    79,    80,    81,    12,    30,   101,    31,    16,    26,
      72,    14,   104,    19,   106,   107,   108,   109,   110,   111,
     112,   113,    72,    70,    71,    21,    35,   117,   119,    27,
     121,   126,   132,    23,   134,    75,    76,    77,    78,    79,
     137,    29,    98,    77,    78,    24,    74,    75,    76,    77,
      78,    79,    80,    81,    28,    48,    72,    93,    75,    76,
      77,    78,    79,    32,   101,    62,    -3,     1,   119,    72,
     103,    64,     2,     3,    16,     4,   119,    96,    97,    65,
      74,    75,    76,    77,    78,    79,    80,    81,    72,   116,
      87,    88,    90,    74,    75,    76,    77,    78,    79,    80,
      81,    91,    92,    95,   123,   122,    72,   124,   125,   128,
     135,   136,    74,    75,    76,    77,    78,    79,    80,    81,
     127,   139,    13,   105,    72,    20,    99,   131,   130,     0,
      74,    75,    76,    77,    78,    79,    80,    81,   129,    72,
       0,     0,     0,     0,     0,     0,    72,     0,    74,    75,
      76,    77,    78,    79,    80,    81,     0,     0,     0,     0,
       0,     0,     0,    74,    75,    76,    77,    78,    79,    80,
      81,    75,    76,    77,    78,    79,    80,    81,    38,    39,
       0,     2,     0,    40,     0,    50,    51,     0,    52,    53,
       0,    54,    55,    41,     0,     0,     0,    29,     0,    38,
      39,     0,     0,    42,    40,    43,    50,    51,     0,    52,
      53,     0,    54,    55,    41,    38,    39,     0,    29,     0,
      40,     0,    38,    39,    42,     0,    43,    40,    38,    39,
      41,     0,     0,    40,    46,    82,     0,    41,     0,     0,
      42,    46,    43,    41,     0,     0,     0,    42,     0,    43,
      85,    38,    39,    42,     0,    43,    40,    38,    39,     0,
       0,     0,    40,     0,     0,     0,    41,   100,     0,     0,
...
{
       8,     0,    46,    11,    24,     4,   128,    27,     7,    18,
      35,    20,     5,    25,   136,    11,     6,     7,    23,    24,
      28,    41,    42,    43,    23,     6,    46,    35,    21,    19,
      50,    56,    28,    18,    89,    20,    29,    30,    31,    32,
      33,    34,    35,    36,     0,    18,    66,    20,    56,    25,
       5,     4,    72,     4,    74,    75,    76,    77,    78,    79,
      80,    81,     5,    38,    39,     4,    65,    87,    88,    29,
      90,   115,   127,    18,   129,    30,    31,    32,    33,    34,
     135,    22,    25,    32,    33,    20,    29,    30,    31,    32,
      33,    34,    35,    36,    24,   115,     5,   122,    30,    31,
      32,    33,    34,    25,   124,    19,     0,     1,   128,     5,
      19,    19,     6,     7,   122,     9,   136,    59,    60,    24,
      29,    30,    31,    32,    33,    34,    35,    36,     5,    25,
      18,    18,    18,    29,    30,    31,    32,    33,    34,    35,
      36,    25,    25,    23,    25,    24,     5,    24,    19,    25,
      12,    25,    29,    30,    31,    32,    33,    34,    35,    36,
      19,    19,     7,    73,     5,     9,    65,   124,   122,    -1,
      29,    30,    31,    32,    33,    34,    35,    36,    19,     5,
      -1,    -1,    -1,    -1,    -1,    -1,     5,    -1,    29,    30,
      31,    32,    33,    34,    35,    36,    -1,    -1,    -1,    -1,
      -1,    -1,    -1,    29,    30,    31,    32,    33,    34,    35,
      36,    30,    31,    32,    33,    34,    35,    36,     3,     4,
      -1,     6,    -1,     8,    -1,    10,    11,    -1,    13,    14,
      -1,    16,    17,    18,    -1,    -1,    -1,    22,    -1,     3,
       4,    -1,    -1,    28,     8,    30,    10,    11,    -1,    13,
      14,    -1,    16,    17,    18,     3,     4,    -1,    22,    -1,
       8,    -1,     3,     4,    28,    -1,    30,     8,     3,     4,
      18,    -1,    -1,     8,    22,    23,    -1,    18,    -1,    -1,
      28,    22,    30,    18,    -1,    -1,    -1,    28,    -1,    30,
      25,     3,     4,    28,    -1,    30,     8,     3,     4,    -1,
      -1,    -1,     8,    -1,    -1,    -1,    18,    19,    -1,    -1,
      -1,    -1,    18,    -1,    -1,    -1,    28,    -1,    30,    -1,
      -1,    -1,    28,    -1,    30
};
...
static const yytype_int8 yystos[] =
{
      ...
      25,    45,     0,    43,     4,    47,    48,    50,    53,     4,
      53,     4,    47,    18,    20,    49,    25,    29,    24,    22,
      56,    56,    25,     7,    19,    45,    54,    55,     3,     4,
       8,    18,    28,    30,    48,    63,    22,    51,    63,    47,
      10,    11,    13,    14,    16,    17,    45,    56,    57,    58,
      61,    63,    19,    50,    19,    24,    18,    63,    63,    63,
      38,    39,     5,    21,    29,    30,    31,    32,    33,    34,
      35,    36,    23,    51,    52,    25,    63,    18,    18,    59,
      18,    25,    25,    50,    62,    23,    57,    57,    25,    54,
      19,    63,    64,    19,    63,    49,    63,    63,    63,    63,
      63,    63,    63,    63,    23,    24,    25,    63,    60,    63,
      58,    63,    24,    25,    24,    19,    51,    19,    25,    19,
      62,    64,    58,    60,    58,    12,    25,    58,    60,    19
};
...
yyreduce:
  ...
  case 2:
#line 51 "sysy.y"
                     {/*printf("CompUnit:\n"); display($1,3);*/ semantic_Analysis0((yyvsp[0].ptr));}
...
#line 1669 "sysy.tab.c"
  ...
  case 14:
#line 74 "sysy.y"
                { (yyval.ptr)=mknode(ARRAYS_TERM,(yyvsp[0].ptr),NULL,NULL,yylineno);strcpy((yyval.ptr)->type_id,(yyvsp[-1].type_id));}
...
#line 1681 "sysy.tab.c"
  ...
  case 16:
#line 78 "sysy.y"
                  {(yyval.ptr)=mknode(ARRAYS,(yyvsp[-1].ptr),NULL,NULL,yylineno);}
...
#line 1699 "sysy.tab.c"
  ...
  case 19:
#line 83 "sysy.y"
                             {(yyval.ptr)=mknode(VAR_DEC,(yyvsp[-2].ptr),(yyvsp[0].ptr),NULL,yylineno);strcpy((yyval.ptr)->type_id,(yyvsp[-2].ptr)->type_id);}
...
#line 1747 "sysy.tab.c"
  ...
  case 27:
#line 97 "sysy.y"
                       {(yyval.ptr)=mknode(FUNC_DEC,NULL,NULL,NULL,yylineno);strcpy((yyval.ptr)->type_id,(yyvsp[-3].type_id));}
...
#line 1957 "sysy.tab.c"
  ...
  case 62:
#line 147 "sysy.y"
                     {(yyval.ptr)=mknode(ARRAY_VAL,(yyvsp[-1].ptr),NULL,NULL,yylineno);}
